    ...
    return (
        <div className="divFormAddProduct">
            <form action="" onSubmit={handleSubmit(enviar)} className="formAddProduct">
                <input className="formInput" type="text" placeholder="Name" {...register('name', { required: true })} />
                {errors.name && <span className="errorText">¡The name is required!</span>}
                <input className="formInput" type="text" placeholder="Image" {...register('image', { required: true })} />
                {errors.image && <span className="errorText">¡The image is required!</span>}
                <input className="formInput" type="number" placeholder="Price" {...register('price', { required: true })} />
                {errors.price && <span className="errorText">¡¡The price is required!</span>}
                <input className="formInput" type="number" placeholder="Stock" {...register('stock', { required: true })} />
                {errors.stock && <span className="errorText">¡The stock is required!</span>}
                <textarea className="formInput textarea" placeholder="Description" {...register('description', { required: true })}></textarea>
